...
class Ai_model(Singleton):
    ...
    def genLesson(self, input: str):
        ...
        plan = self.talkToModel(messages, True)
        return plan
    ...
    def genSession(self, session: str, lessonName: str):
        ...
        messages = [SystemMessage(sys_template),HumanMessage(session)]
        plan = self.talkToModel(messages, False)
        return plan
    ...
    def genTest(self, lessonName: str, lessonPart: dict):
        ...
        messages = [SystemMessage(sys_template),HumanMessage(str(lessonPart))]
        plan = self.talkToModel(messages, False)
        return plan
